...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-1knkika.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-1knkika.containers.anotherwebservice.com/
...
```
git clone git@github.com:HellcatPoggers/container-1knkika.git
cd container-1knkika
```
...
```
docker attach container-1knkika
```
